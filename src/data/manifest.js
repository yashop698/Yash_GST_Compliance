export const TOPICS = [
  {
    ...
    color: '#1d4ed8',
    bg: '#dbeafe',
    summary: 'Section 9(3)/(4) CGST · Section 5(3)/(4) IGST · Rules 3/4/5',
    docs: [
  ...
  },
  {
    ...
    color: '#b91c1c',
    bg: '#fee2e2',
    summary: 'Section 17(5)(a)–(i) CGST · Finance Act 2021 construction amendment',
    docs: [
  ...
  {
    id: 'apr',
    label: 'ITC Apportionment',
    abbr: 'APR',
    color: '#15803d',
    bg: '#dcfce7',
    summary: 'Rule 43 CGST Rules · Section 17(2)/(3) CGST',
    docs: [
  ...
  },
  {
    ...
    color: '#6d28d9',
    bg: '#ede9fe',
    summary: 'Glossary · Amendments Timeline · Cross-Topic Map · Disputed Areas',
    docs: [
